            ...
            builder: (context, AsyncSnapshot<Evento> snapshotevento) {
              ...
              return Row(
                ...
                children: <Widget>[
                  ...
                  InkWell(
                    onTap: (){
                      //todo: checar si se queda asi, o hacemos una vista aparte
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => PantallaDetalleEvento(evento: snapshotevento.data,)));
                    },
                    child: Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: Text("Termina: " + promocion.Fecha,
