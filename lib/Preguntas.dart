...
class Preguntas extends StatefulWidget {
  @override
  _Preguntas createState() => _Preguntas();
}

class _Preguntas extends State<Preguntas> {
          ...
          Container(
            child:  Align(
              ...
              child: Padding(
                ...
                child: Text("Preguntas frecuentes",style: TextStyle(color: Colors.white,fontSize: 22,fontWeight: FontWeight.bold)),
              ),
            ),
              ...
              child: Container(
                ...
                child: PageView(
                  ...
                  children: <Widget>[
                    ...
                    Pantalla(
                      titulo: "¿Como puedo encotrar los boletos que compre",
                      descripcion: "Despues de haber comprado tus boletos recibiras un correo"
                          " de confirmacion en el cual se te proporciona el codigo de tu boleto",
                      imagen: "img/questions.png",
                    ),
                  ],
                ),
              ),
