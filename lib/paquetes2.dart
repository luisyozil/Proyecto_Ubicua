...
class Paquetes2 extends StatefulWidget {
  ...
  Paquetes2({this.evento, this.usuario});
                                        ...
                                        children: <Widget>[
                                          ...
                                          Padding(
                                            ...
                                            const EdgeInsets.symmetric(
                                                ...
                                                vertical: 4.0),
                                            child: Text(
                                              "${paquetes[position].transporte == true ? "Transporte" : ""}",
                                              style:
                                          ...
                                          Padding(
                                            ...
                                            const EdgeInsets.symmetric(
                                                ...
                                                vertical: 4.0),
                                            child: Text(
                                              "${paquetes[position].hospedaje == true ? "Hospedaje" : ""}",
                                              style:
                                              TextStyle(fontSize: 15.0),
                                            ),
                                          ),
                                          ...
                                          Padding(
                                            ...
                                            child: GestureDetector(
                                              onTap: () {
                                                db.GuardaElemento(Elemento(IdPaquete: paquetes[position].id, IdUsuario: widget.usuario.uid));
                                                Navigator.pop(context);
                                              },
                                              child: Container(
                                                width: 300,
